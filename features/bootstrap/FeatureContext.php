...
class FeatureContext extends DrupalContext {
  ...
  */
  ...
  public function iShouldSeeAtLeastMostInstalledModules($count) {
    ...
    $links = $this->getSession()->getPage()->findAll("css", "#block-drupalorg_order_facet-iss_project_release_usage ul li a");
    if (empty($links)) {
  ...
  */
  ...
  public function recentlyPublishedFeaturedCaseStudy($count, $context = "") {
    ...
    $temp = $this->getSession()->getPage()->findAll("css", "#block-views-drupalorg_casestudies-block_3 .view-drupalorg-casestudies ul li span h2");
    if (empty($temp)) {
