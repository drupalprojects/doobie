...
Feature: Verify home page header
  ...
  @anon @known_git6failure @flaky
  Scenario Outline: Home page header text doesn't appear on other pages
    Given I am on "<page>"
  ...
  Scenario Outline: View search filter options upon clicking Refine your search link in header area on other pages
    Given I am on "<page>"
  ...
  @anon @known_git6failure @flaky
  Scenario Outline: View bottom header tabs
    Given I am on "<page>"
